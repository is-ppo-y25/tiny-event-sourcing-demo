...
import ru.quipy.projections.TaskEventSubscriber
...
class EventSourcingLibConfiguration {
    ...
    @Autowired
    private  lateinit var taskEventSubscriber: TaskEventSubscriber
    ...
    @Bean
    fun userEsService() = eventSourcingServiceFactory.create<UUID, UserManagerAggregate, UserManagerAggregateState>()
    @PostConstruct
    fun init() {
        ...
        subscriptionsManager.subscribe<ProjectAggregate>(taskEventSubscriber)
